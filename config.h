...
// TODO: Find a way to default to this if no theme is included. See statuscolors below also
...
// TODO: Find a way to default to this if no theme is included
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,              XK_Down,       rotatestack,            {.i = +1 } },
	{ MODKEY|Mod1Mask,              XK_Up,         rotatestack,            {.i = -1 } },
	...
	#if VANITYGAPS_PATCH
	// Uncomment the following for dynamic gap resizing keybindings
